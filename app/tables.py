from flask_table import Table, Col, LinkCol, create_table, NestedTableCol, ButtonCol
...
class ModalButtonCol(ButtonCol):
    ...
    def __init__(self,name,endpoint,**kwargs):
        super(ModalButtonCol, self).__init__(name,endpoint,**kwargs)
...
class TestTableModalButtonCol(Table):
    ...
    age = Col('age',column_html_attrs=column_html_attrs)
    sex = Col('sex',column_html_attrs=column_html_attrs)
    modal_col = LinkCol('test_modal',endpoint='main.home',
